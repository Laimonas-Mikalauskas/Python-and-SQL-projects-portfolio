...
def __init__(self, name: str, surname: str, birthday: int, role: str, started_working: int, salary: int, experience: int, tools: str):
    self.name = name
...
name = "Alice, Charlie"
print("Alice, Charlie")
print(type("Alice, Charlie"))

surname = "Smith, Watson"
print("Smith, Watson")
print(type("Smith, Watson"))
...
class User(Base):
    __tablename__ = "users"
    id = Column(Integer, primary_key=True)
    register = Column(String, unique=True)
...
def __init__(self, register, login, username=None, password=None, logout=None):
